# -*- coding: utf-8 -*-
#
# openbci documentation build configuration file, created by
# sphinx-quickstart on Tue Feb 23 17:20:20 2016.
#
...
latex_documents = [
    (master_doc, 'openbci.tex', u'openbci Documentation',
     u'BrainTech', 'manual'),
]
...
man_pages = [
    (master_doc, 'openbci', u'openbci Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'openbci', u'openbci Documentation',
     author, 'openbci', 'One line description of project.',
     'Miscellaneous'),
]
