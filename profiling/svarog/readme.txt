...
2.10 
3. (in svarog dir) run mvn clean && mvn compile && mvn exec:java
4. Open 'montage' dialog 
5. Import predefined montage profiling_50 (if you are using 50 channels)
...
after finishing run in jmx and svarog dit:
git reset --hard HEAD && rm src/main/java/org/signalml/app/util/Stopwatch.java && rm /home/mati/.m2/repository/multiplexer/jmx/0.9.1/jmx-0.9.1.jar
