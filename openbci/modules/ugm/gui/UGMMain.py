...
#
# Created: Mon Feb 15 10:51:29 2010
...
class Ui_UGMMainWidget(object):
    def setupUi(self, UGMMainWidget):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/buttons/save"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/buttons/add"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/buttons/add_rectangle"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.addRectangleButton.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/buttons/add_image"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.addImageButton.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/buttons/add_text"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.addTextButton.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/buttons/remove"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/buttons/save"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave.setIcon(icon7)
        self.actionSave.setObjectName("actionSave")
        self.actionAdd = QtGui.QAction(UGMMainWidget)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/buttons/add"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAdd.setIcon(icon8)
        self.actionAdd.setObjectName("actionAdd")
        self.actionRemove = QtGui.QAction(UGMMainWidget)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/buttons/remove"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRemove.setIcon(icon9)
        self.actionRemove.setObjectName("actionRemove")
        self.actionAddRectangle = QtGui.QAction(UGMMainWidget)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/buttons/add_rectangle"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAddRectangle.setIcon(icon10)
        self.actionAddRectangle.setObjectName("actionAddRectangle")
        self.actionAddImage = QtGui.QAction(UGMMainWidget)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/buttons/add_image"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAddImage.setIcon(icon11)
        self.actionAddImage.setObjectName("actionAddImage")
        self.actionAddText = QtGui.QAction(UGMMainWidget)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/buttons/add_text"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAddText.setIcon(icon12)
    ...
    def retranslateUi(self, UGMMainWidget):
        ...
        self.actionSendToUgm.setShortcut(QtGui.QApplication.translate("UGMMainWidget", "Ctrl+Shift+S", None, QtGui.QApplication.UnicodeUTF8))
