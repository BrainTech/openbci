...
class P300TrainUgmEngine(ugm_engine.UgmEngine):
    ...
    def __init__(self):
        ...
        super(P300TrainUgmEngine, self).__init__(ugm_config_manager.UgmConfigManager('black'))
    ...
    def run(self):
        ...
        super(P300TrainUgmEngine, self).run()
