...
task("./analysis/ssvep_csp/csp_calibration_server.py", "csp_calibration")
task("./analysis/ssvep_csp/csp_bci_analysis_server.py", "csp_analysis")
...
start("diode", "ugm")
start("diode", "super_diode_control")
...
start("ms", "logics_control")

start("ms", "blinking_ugm")
start("ms", "virtual_f_amplifier")
#start("ms", "c++_bt_mobi5_amplifier")
...
start("ms", "ssvep_analysis")
start("ms", "super_diode_control")


start("switch", "hashtable")
start("switch", "logics_multiple")
...
start("mati_exp", "super_diode_control")
...
start("mati_real_exp", "super_diode_control")
...
start("virtual_p300", "super_diode_control")
...
start("pokaz", "super_diode_control")
start("pokaz", "ugm")
start("pokaz", "logics")
...
start("test_experiment", "super_diode_control")
...
start("experiment", "super_diode_control")
...
# fft ssvep -------------------------------------------
start("ssvep_fft", "hashtable")
start("ssvep_fft", "logics")
start("ssvep_fft", "ugm")
