...
start("ssvep", "hashtable")
start("ssvep", "logics")
start("ssvep", "ugm")
start("ssvep", "virtual_f_amplifier")
#start("ssvep", "c++_bt_mobi5_amplifier")
start("ssvep", "ssvep_analysis")
start("ssvep", "super_diode_control")
start("ssvep", "logics_control")
