# -*- coding: utf-8 -*-
#
# control documentation build configuration file, created by
...
latex_documents = [
  ('index', 'control.tex', u'obci\\_control Documentation',
...
man_pages = [
    ('index', 'control', u'obci_control Documentation',
...
texinfo_documents = [
  ('index', 'control', u'obci_control Documentation',
   u'Titanis / Joanna Tustanowska', 'control', 'One line description of project.',
   'Miscellaneous'),
]
