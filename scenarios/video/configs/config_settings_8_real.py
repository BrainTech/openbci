...
class Config(config_settings_8.Config):
    def __init__(self):
        self._scenarios = [
            "~/obci/scenarios/video/bci_p300_menu.ini",
            "~/obci/scenarios/video/calibration_ssvep.ini",
            #"~/obci/scenarios/video/bci_p300_menu_dummy.ini",
            "~/obci/scenarios/video/bci_ssvep_menu.ini",
            "~/obci/scenarios/video/bci_ssvep_menu_c1.ini",
            "~/obci/scenarios/video/bci_ssvep_menu.ini",
            "~/obci/scenarios/video/bci_ssvep_menu.ini",
            "~/obci/scenarios/video/bci_ssvep_menu.ini",
            "~/obci/scenarios/video/bci_ssvep_menu.ini",
